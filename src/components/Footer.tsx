        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2 text-sm text-gray-700 max-w-xs">
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-[#271813] hover:text-[#25D366] transition-colors font-medium"
            >
              <svg className="w-5 h-5 text-[#271813] fill-current" viewBox="0 0 24 24">
